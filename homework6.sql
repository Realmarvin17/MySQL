...
-- Создаем  функцию seconds_format, которая принимает один аргумент
...
-- переменные внутри функции: days, hours, minutes и formatted.
BEGIN
    DECLARE days INT;
    DECLARE hours INT;
    DECLARE minutes INT;
...
-- вернуть значение переменной formatted.
    RETURN formatted;
END //
